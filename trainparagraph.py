...
def parse_arguments():
    ...
    parser.add_argument('--pretrain', type=str, default=None, help="Model pretrained weights to load")
...
def main():
    ...
    model_train, model_pred, model_base = get_paragraph_model(input_shape=(None, None, 1), out_tokens=len(w2i))
